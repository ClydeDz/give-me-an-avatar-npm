...
1. Ensure any install or build dependencies are removed before the end of the layer when doing a 
   build.
2. Update the README.md with details of changes to this package. For example, if you're adding a avatar new service, please update the readme table.
3. Increase the version number in the `package.json` file. The versioning scheme we use is [SemVer](http://semver.org/).
